...
const HealthFacilitiesButton: React.FC = () => {
  ...
  return (
    <button
      ...
      className="border border-dashed border-red-500 bg-red-500 text-white text-xs sm:text-sm px-4 font-bold py-3 rounded hover:bg-red-600 transition-colors duration-300 w-full flex items-center justify-center gap-2"
    >
