...
const testimonials = [
  {
    ...
    quote: "لاحظت تحسّن طاقتي بشكل واضح خلال الشهر الثاني، ما عدت أحتاج قهوة الظهر.",
  },
  {
    initials: "ن.ش",
    name: "نورة الشهري",
    ...
    quote: "التعب الصباحي اللي كنت أعاني منه لسنوات اختفى تقريباً. نصيحة طبيبي كانت دقيقة.",
  },
  {
    initials: "س.ق",
    name: "سعد القحطاني",
    ...
    quote: "تركيزي في العمل تحسّن بشكل ملحوظ. الطبيب كان متواصل معاي طوال الفترة.",
  },
];

const stats = [
  { num: "٢٬٤٠٠", sup: "+", label: "مشترك فعّال في المملكة" },
  { num: "٨٧", sup: "%", label: "تحسّنت مؤشّراتهم خلال ٩٠ يوم" },
];
  ...
  return (
    <section className={s.wrap}>
      <div className={s.head}>
        ...
        <p className={s.sub}>
          تغيّرت نتائج تحاليل مشتركينا خلال ٩٠ يوماً من الفيتامينات المخصّصة
          التي يختارها الطبيب بناءً على أرقامهم الشخصية.
        </p>
      </div>
