...
const faqs = [
  ...
  {
    question: "هل الفيتامينات آمنة؟",
    answer:
      "نعم، جميع المكملات الغذائية مرخصة من هيئة الغذاء والدواء ومصممة خصيصاً بناءً على نتائج تحاليلك الشخصية.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "يشمل الفحص أكثر من ٣٠ مؤشراً حيوياً تتضمن الفيتامينات والمعادن ووظائف الأعضاء والهرمونات والدهون وغيرها.",
  },
];
