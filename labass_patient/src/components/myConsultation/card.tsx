  ...
  return (
    ...
    >
      <div className="w-full flex flex-col justify-between" dir="rtl">
        <div className="flex flex-row justify-between mb-2">
          <div className="flex flex-row">
            ...
            <h3 className="font-bold text-md text-black" dir="rtl">
              {`د. ${consultation.patient.user.firstName} ${consultation.patient.user.lastName}`}{" "}
            </h3>
          </div>
        ...
        <div className="flex flex-row flex-wrap justify-start gap-2 mt-4 text-sm" dir="rtl">
